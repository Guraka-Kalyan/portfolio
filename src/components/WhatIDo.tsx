        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                responsive UIs, RESTful APIs, and database integrations.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>UI/UX & Tooling</h4>
              <p>
                Designing clean, responsive interfaces and deploying production
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Nodemailer</div>
                <div className="what-tags">SSH / Linux</div>
